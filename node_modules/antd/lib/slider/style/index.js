    ...
    [componentCls]: Object.assign(Object.assign({}, (0, _style.resetComponent)(token)), {
      ...
      '&:hover': {
        ...
        [`${componentCls}-handle::after`]: {
          boxShadow: `0 0 0 ${(0, _cssinjs.unit)(token.handleLineWidth)} ${token.colorPrimaryBorderHover}`
        },
      ...
      [`${componentCls}-handle`]: {
        ...
        '&::after': {
          ...
          boxShadow: `0 0 0 ${(0, _cssinjs.unit)(token.handleLineWidth)} ${token.handleColor}`,
          borderRadius: '50%',
          cursor: 'pointer',
          transition: `
        ...
        '&:hover, &:active, &:focus': {
          ...
          '&::after': {
            boxShadow: `0 0 0 ${(0, _cssinjs.unit)(token.handleLineWidthHover)} ${token.handleActiveColor}`,
      ...
      [`${componentCls}-dot`]: {
        ...
        height: dotSize,
        backgroundColor: token.colorBgElevated,
        border: `${(0, _cssinjs.unit)(token.handleLineWidth)} solid ${token.dotBorderColor}`,
        borderRadius: '50%',
        cursor: 'pointer',
      ...
      [`&${componentCls}-disabled`]: {
        ...
        [`${componentCls}-handle::after`]: {
          ...
          width: token.handleSize,
          height: token.handleSize,
          boxShadow: `0 0 0 ${(0, _cssinjs.unit)(token.handleLineWidth)} ${handleColorDisabled}`,
          insetInlineStart: 0,
          insetBlockStart: 0
        },
        [`
